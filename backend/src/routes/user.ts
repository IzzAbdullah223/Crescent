...
import { getUser,searchUsers,getUserByID,updateProfile, changeProfilePicture,followUser,unfollowUser,getLatestUsers,getMostFollowedUsers   } from '../controllers/userController.js'
...
userRouter.get('/users/latest', verifyToken, getLatestUsers)
userRouter.get('/users/most-followed', verifyToken, getMostFollowedUsers)
