...
import { createPost,getPosts, likePost,unlikePost,getLikedPosts,getUserPosts,getPostComments } from '../controllers/postController.js'
...
postRouter.get('/posts/:id/comments',verifyToken,getPostComments)
