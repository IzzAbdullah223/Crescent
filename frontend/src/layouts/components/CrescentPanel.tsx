export default function CrescentPanel() {
  return (
    <div className="relative flex items-center justify-center w-full h-full bg-[#080808] overflow-hidden">
      ...
      <svg
        viewBox="100 215 360 255"
        xmlns="http://www.w3.org/2000/svg"
        className="relative z-10 w-[80%] max-w-[420px]"
      >
        <defs>
        ...
        <g transform="translate(250,225) rotate(-6)">
